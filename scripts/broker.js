 ...
 * @return success or failure message in #brokerMessage element
 *   
 */
...
function editBroker() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById('editBrokerAddress1').value = data['addressLine1'];
            document.getElementById('editBrokerAddress2').value = data['addressLine2'];
            document.getElementById('editBrokerAddress3').value = data['addressLine3'];
            document.getElementById('editBrokerAddress4').value = data['addressLine4'];
            document.getElementById('editBrokerAddress5').value = data['addressLine5'];
