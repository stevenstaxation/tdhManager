...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
    $returnString .= "<tr>";
    $returnString .= "<td class='align-middle pl-1'>" . $row['firstName'] . "</td>";
    $returnString .= "<td class='align-middle pl-1'>" . $row['lastName'] . "</td>";
    $returnString .= "<td class='align-middle pl-1'>" . $row['jobTitle'] . "</td>";
    ...
    $returnString .= "<td class='align-middle pl-1'>" . $row['email'] . "</td>";
    $returnString .= "<td class='align-middle px-1'><center><input type='checkbox' class='isFootageRequest' name='isFootageRequest' onclick='return false' " . ($row['isFootageRecipient'] == 1 ? 'checked' : '') . " value='1'/>&nbsp;</center></td>";
    $returnString .= "<td class='align-middle px-1'><center><input type='checkbox' class='isHealthCheck' name='isHealthCheck' onclick='return false' " . ($row['isHealthCheck'] == 1 ? 'checked' : '') . " value='1'/>&nbsp;</center></td>";
