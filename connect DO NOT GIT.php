...
$link = mysqli_connect('localhost', 'root', 'W1!!14m%t3v3n5', 'TDHManager');
if (mysqli_connect_error()) {
	die("Database is unavailable, please try again later - " . mysqli_connect_error());
}

// $link = mysqli_connect('tdhdbserver.mysql.database.azure.com', 'tdh_superuser@tdhdbserver', 'W1!!14m%t3v3n5', 'TDHManager');
// if (mysqli_connect_error()) {
// 	die("Database is unavailable, please try again later - " . mysqli_connect_error());
// } 
	...
	// $link = mysqli_connect('thedatahub.database.windows.net', 'dataHub29', 'W1!!14m%t3v3n5', 'TDHManager');
    // if (mysqli_connect_error()) {
    //     die("Database is unavailable, please try again later - " . mysqli_connect_error());
    // }

	// $host = 'thedatahub.database.windows.net';
	// $username = 'dataHub29';
	// $password = 'W1!!14m%t3v3n5';
	// $db_name = 'TDHManager';

	// $connectionInfo = array("UID" => "dataHub29", "pwd" => "W1!!14m%t3v3n5", "Database" => "TDHManager", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
	// $serverName = "tcp:thedatahub.database.windows.net,1433";
