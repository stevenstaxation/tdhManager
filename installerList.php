    ...
    <div class='col-lg-5 col-xl-4 settings-dialog'>
       ...
       ";
        ...
        <div class='btn-group' style ='display: flex; margin: 10px 20px;'>
            <btn class='btn btn-success btn-sm' style='margin: 0 10px' id='addNewInstaller' type='button' data-toggle='modal' data-target='#modalAddNewInstaller' data-caller='installer'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-plus-circle-fill' viewBox='0 0 16 16'>
        ...
        <div class='col-lg-6 col-xl-7 settings-dialog'>
            ...
            <label class='control-label inline' for='installerName' style='width:40%; padding-top:6px'>Name </label>
            <div class='input-group'>
                <input style='font-size: 80%' maxlength='100' class='form-control' type='text' id='editInstallerName' name='editInstallerName' 
                placeholder='installer name...' value=''>
            </div>   
        </div>
            <div class='form-group' style='display: flex; align-items: center'>
                <label class='control-label inline' for='editInstallerAddress1' style='width:40%; padding-top:6px'>Address </label>
                <div class='input-group'>
                    <input style='font-size: 80%' maxlength='100' class='form-control' type='text' id='editInstallerAddress1' name='editInstallerAddress1' 
                    placeholder='address line 1...' value=''>
                </div>   
            </div>
            <div class='form-group' style='display: flex; align-items: center'>
                <label class='control-label inline' for='editInstallerAddress2' style='width:40%; padding-top:6px'>Address </label>
                <div class='input-group'>
                    <input style='font-size: 80%' maxlength='100' class='form-control' type='text' id='editInstallerAddress2' name='editInstallerAddress2' 
                    placeholder='address line 2...' value=''>
                </div>   
            </div>
            <div class='form-group' style='display: flex; align-items: center'>   
                <label class='control-label inline' for='editInstallerAddress3' style='width:40%; padding-top:6px'>Town/City </label>
                <div class='input-group'>
                    <input style='font-size: 80%' maxlength='100' class='form-control' type='text' id='editInstallerAddress3' name='editInstallerAddress3' 
                    placeholder='town/city...' value=''>
                </div>   
            </div>
            <div class='form-group' style='display: flex; align-items: center'>            
                <label class='control-label inline' for='editInstallerAddress4' style='width:40%; padding-top:6px'>County </label>
                <div class='input-group'>
                    <input style='font-size: 80%' maxlength='100' class='form-control' type='text' id='editInstallerAddress4' name='editInstallerAddress4' 
                    placeholder='county...' value=''>
                </div>   
            </div>
            <div class='form-group' style='display: flex; align-items: center'>        
                <label class='control-label inline' for='editInstallerAddress5' style='width:40%; padding-top:6px'>Post Code </label>
                <div class='input-group'>
                    <input style='font-size: 80%' maxlength='100' class='form-control' type='text' id='editInstallerAddress5' name='editInstallerAddress5' 
            ...
            <div class='row'>
            <div class='btn-group' style ='display: flex; margin: 10px 20px;'>
            <btn class='btn btn-success btn-sm updateEditInstaller' style='margin: 0 10px' onclick='updateEditInstaller()' id='updateEditInstaller' type='button'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-arrow-up-left-circle-fill' viewBox='0 0 16 16'>
...
<div class='col-lg-12 col-xl-7 settings-dialog'>
    ...
    <btn class='btn btn-success btn-sm' id='btnAddNewInstallerContact' style='margin: 0 10px' type='button' data-toggle='modal' data-target='#modalAddNewInstallerContact' data-caller='installer'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16'
