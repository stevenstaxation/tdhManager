...
// before update
$sql = "SELECT * FROM tblOtherContact WHERE ID = '$contactCustomer'";
$prev = mysqli_fetch_assoc(mysqli_query($link, $sql));

// update
$sql = "UPDATE tblOtherContact SET firstName='$contactFirstName', lastName='$contactLastName', mobileNo='$contactMobileNumber', telephone='$contactTelephone', email='$contactEmail', department='$contactDepartment' WHERE ID = '$contactCustomer'";
...
// parse changes
$description="Other partner contact " . $contactFirstName . " " . $contactLastName . " was edited - " ;
