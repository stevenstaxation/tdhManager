...
$contactDepartment = mysqli_real_escape_string($link,$contactDepartment);
 ...
 $sql = "INSERT INTO tblInstallerContact (installerID, firstName, lastName, mobileNo, telephone, email, department) VALUES ('$installerID','$contactFirstName', '$contactLastName', '$contactMobileNumber', '$contactTelephone', '$contactEmail', '$contactDepartment')";
...
$sql = "INSERT INTO tblEventLog (Description, UserID) VALUES ('Installer contact $contactFirstName $contactLastName was created in $installerName', '" . $_SESSION['userID']. "')";
$result = mysqli_query($link, $sql);
