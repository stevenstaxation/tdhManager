...
$contactDepartment = mysqli_real_escape_string($link,$contactDepartment);
 ...
 $sql = "INSERT INTO tblOtherContact (otherID, firstName, lastName, mobileNo, telephone, email, department) VALUES ('$otherID','$contactFirstName', '$contactLastName', '$contactMobileNumber', '$contactTelephone', '$contactEmail', '$contactDepartment')";
...
$sql = "INSERT INTO tblEventLog (Description, UserID) VALUES ('Partner contact $contactFirstName $contactLastName was created in $otherName', '" . $_SESSION['userID']. "')";
$result = mysqli_query($link, $sql);
