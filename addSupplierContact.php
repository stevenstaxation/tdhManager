...
$contactDepartment = mysqli_real_escape_string($link,$contactDepartment);
 ...
 $sql = "INSERT INTO tblSupplierContact (supplierID, firstName, lastName, mobileNo, telephone, email, department) VALUES ('$supplierID','$contactFirstName', '$contactLastName', '$contactMobileNumber', '$contactTelephone', '$contactEmail', '$contactDepartment')";
...
$sql = "INSERT INTO tblEventLog (Description, UserID) VALUES ('Supplier contact $contactFirstName $contactLastName was created in $supplierName', '" . $_SESSION['userID']. "')";
$result = mysqli_query($link, $sql);
