...
$sql = "INSERT INTO tblDevice (ownerID, isCamera, deviceDescriptionID, TDHNumber, serialNumber, IMEI, DRIDNumber, SIMNumber, SIMPhone, SIMStatus, SIMDeactivationDate,
  config, cameraUsedFor, vehicleID, status, installerID, installDate, assocOrderNumber, supplierID, supplierInvoice, buyer, purchaseDate, deviceNote)
  VALUES ('$customerID', '1','$deviceTypeID', NULLIF('$deviceTDHNumber',''), '$deviceSerialNumber', NULLIF('$deviceIMEI',''), '$deviceDRID','$deviceSIMNumber', '$deviceSIMPhone','$deviceSIMStatusID',
  ...
  '$deviceInstallerRef', NULLIF('$deviceSupplierID',''), '$deviceSupplierRef', '$deviceBuyer', NULLIF('$devicePurchaseDate',''), '$deviceNotes')";
